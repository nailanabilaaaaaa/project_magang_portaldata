...
<div class="row">
    ...
    <div class="col-lg-2">
        <a href="{{ route('data.create') }}" class="btn btn-primary btn-rounded btn-fw"><i class="fa fa-plus"></i>
          Add Data</a>
    </div>
                                ...
                                <td>
                                    <div class="btn-group dropdown">
                                        ...
                                        <div class="dropdown-menu" x-placement="bottom-start"
                                            ...
                                            <a class="dropdown-item" href="{{route('data.edit', $data->id)}}"> Edit </a>
                                            <form action="{{ route('data.destroy', $data->id) }}" class="pull-left"
                                                method="post">
                                                {{ csrf_field() }}
                                                {{ method_field('delete') }}
